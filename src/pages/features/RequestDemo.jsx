...
export const RequestDemo = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-white px-6 py-8 font-sans lg:px-20 lg:py-16">
      ...
      >
        <div className="mb-12 mt-10 flex w-full justify-center lg:mb-20 xl:mb-16">
          <h1 className="text-primary text-2xl font-black uppercase tracking-tight lg:text-8xl xl:text-3xl">
            Shelter Cleaning
          </h1>
        </div>
        ...
        <div className="mb-10 text-center lg:mb-20 xl:mb-16">
          <h1 className="text-2xl font-black uppercase tracking-tight text-sky-500 lg:text-6xl xl:text-3xl">
            Request Demo
          </h1>
